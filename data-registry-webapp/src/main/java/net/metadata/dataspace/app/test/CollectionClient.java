...
public class CollectionClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String name = "New Collection" + new Random().nextInt(5000);
        entry.setTitle(name);
        entry.setSummary("This is a description of " + name);
        entry.setContent("Optional Content");
        // Add the Specific extensions
        ((Element) entry.addExtension(new QName("http://http://www.w3.org/2005/Atom", "location"))).setAttributeValue("value", UUID.randomUUID().toString());
