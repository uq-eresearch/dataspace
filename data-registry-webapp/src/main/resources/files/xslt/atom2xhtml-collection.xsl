...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="atom:entry">
        ...
        <body>
            ...
            <h2>Description</h2>
            <dl>
                <xsl:apply-templates select="atom:category[@scheme = 'https://services.ands.org.au/home/orca/services/getRegistryObjectGroups.php']"/>
    ...
    <xsl:template
        ...
        <li>
            <dt>Published by</dt>
            <dd><xsl:value-of select="@term"/></dd>
        </li>
    </xsl:template>
    ...
    <xsl:template name="updated">
        <li>
            <dt>updated</dt>
            <dd><xsl:value-of select="atom:updated"/> by <xsl:value-of select="atom:author/atom:name"/></dd>
        </li>
    </xsl:template>
