            ...
            <div class="wrapper">
                ...
                <div class="save-links-div">
                    <a href="#" class="save-link" id="save-link" title="Save Record"
                       onclick="DataSpace.ingestRecord('/services','service',true, false); return false;">save
                    </a>
                    <a href="#" class="publish-link" id="publish-link" title="Publish Record"
                       onclick="DataSpace.ingestRecord('/services','service',true, true); return false;">publish
                    </a>
                </div>
