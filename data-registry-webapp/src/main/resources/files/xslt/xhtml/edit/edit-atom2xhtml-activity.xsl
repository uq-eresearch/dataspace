            ...
            <div class="wrapper">
                ...
                <div class="save-links-div">
                    <a href="#" class="save-link" id="save-link" title="Save Record"
                       onclick="ingestRecord('{atom:link[@rel = $REL_SELF]/@href}','activity',false, false); return false;">
                        save
                    </a>
                    <a href="#" class="publish-link" id="publish-link" title="Publish Record"
                       onclick="ingestRecord('{atom:link[@rel = $REL_SELF]/@href}','activity',false, true); return false;">
                        publish
                    </a>
                </div>
