...
public class AgentIT {
    ...
    public void testAgentFeed() throws Exception {
        ...
        String feedUrl = TestConstants.URL_PREFIX + TestConstants.PATH_FOR_AGENTS;
        //get without authenticating
    ...
    public void testAgentRecordContent() throws Exception {
        ...
        assertTrue("Entry's \"describes\" relation does not contain path to entry: "+relDescribes, relDescribes.contains(TestConstants.PATH_FOR_AGENTS));
    ...
    public void testAgentFeedContent() throws Exception {
        ...
        assertTrue("Feed's id does not contain path to entry", id.contains(TestConstants.PATH_FOR_AGENTS));

        String title = xpath.evaluate(TestConstants.FEED_TITLE_PATH, docFromStream);
        assertNotNull("Feed missing title", title);
        assertEquals("Feed's title is incorrect", TestConstants.TITLE_FOR_AGENTS, title);
        ...
        assertTrue("Feed entry's id does not contain path to entry: "+entryId, entryId.contains(TestConstants.PATH_FOR_AGENTS));
