...
public class ServiceIT {
    ...
    public void testServiceCRUD() throws Exception {
        ...
        PostMethod postMethod = ClientHelper.postEntry(client, fileName, TestConstants.PATH_FOR_SERVICES);
    ...
    public void testServiceUnauthorized() throws Exception {
        ...
        postMethod = ClientHelper.postEntry(client, fileName, TestConstants.PATH_FOR_SERVICES);
        assertEquals("Could not post entry", 201, postMethod.getStatusCode());
        String newEntryLocation = postMethod.getResponseHeader("Location").getValue();
    ...
    public void testServiceFeed() throws Exception {
        ...
        String feedUrl = TestConstants.URL_PREFIX + TestConstants.PATH_FOR_SERVICES;
        //get without authenticating
    ...
    public void testServiceRecordContent() throws Exception {
        ...
        assertTrue("Entry's id does not contain path to entry", id.contains(TestConstants.PATH_FOR_SERVICES));
...
//        String authorName = xpath.evaluate(TestConstants.RECORD_SOURCE_AUTHOR_NAME_PATH, docFromStream);
//        assertNotNull("Entry missing author name", authorName);
//        String originalAuthorName = xpath.evaluate(TestConstants.RECORD_SOURCE_AUTHOR_NAME_PATH, docFromFile);
...
//        assertEquals("Entry's author name is incorrect", originalAuthorName, authorName);
    ...
    public void testServiceFeedContent() throws Exception {
        ...
        assertTrue("Feed's id does not contain path to entry", id.contains(TestConstants.PATH_FOR_SERVICES));

        String title = xpath.evaluate(TestConstants.FEED_TITLE_PATH, docFromStream);
        assertNotNull("Feed missing title", title);
        assertEquals("Feed's title is incorrect", TestConstants.TITLE_FOR_SERVICES, title);
        ...
        assertTrue("Feed entry's id does not contain path to entry", entryId.contains(TestConstants.PATH_FOR_SERVICES));
