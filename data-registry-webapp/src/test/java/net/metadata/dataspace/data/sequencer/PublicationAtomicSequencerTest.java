...
public class PublicationAtomicSequencerTest {
    ...
    public void testNext() throws Exception {
        int currentNumber = publicationSequencer.current();
        assertTrue("Current number should be smaller than next number.", currentNumber < publicationSequencer.next());
    }
